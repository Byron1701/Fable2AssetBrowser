...
constexpr uint32_t kMarkVer   = 0x4AD78C59u;
constexpr uint32_t kBaad      = 0xBAADF00Du;
constexpr uint32_t kChildMark = 0x37E185B9u;
constexpr size_t   kSec4Fixed = 0x1C917E;
...
void read_standard(Reader& r, Emitter& e) {
    ...
    skip_vtl(r);
    e.acc_x = read_stl(r, 6);
    e.acc_y = read_stl(r, 7);
    e.acc_z = read_stl(r, 8);
...
void read_light(Reader& r, Emitter& e) {
    r.u8(); r.u32();
    skip_vtl(r);
...
void read_light8(Reader& r, Emitter& e) {
...
void read_spline_entity(Reader& r, Emitter& e) {
    r.u32(); r.u8();
...
void read_spline_emitter(Reader& r, Emitter& e) {
    read_emitter_tail(r, e);
    r.u32(); r.u32(); r.u8(); r.u8(); r.f32(); r.skip(4);
...
void read_attractor(Reader& r, Emitter& e) {
